    ...
    <nav className="bg-gray-900 text-white shadow-lg px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link to="/create-task" className="text-lg font-semibold bg-gradient-to-r from-purple-300 to-indigo-400 text-transparent bg-clip-text hover:text-indigo-300 transition duration-200">
            Create Task
          </Link>
          <Link to="/update-task" className="text-lg font-semibold bg-gradient-to-r from-purple-300 to-indigo-400 text-transparent bg-clip-text hover:text-indigo-300 transition duration-200">
            Update Task
          </Link>
          <Link to="/delete-task" className="text-lg font-semibold bg-gradient-to-r from-purple-300 to-indigo-400 text-transparent bg-clip-text hover:text-indigo-300 transition duration-200">
            Delete Task
          </Link>
          <Link to="/all-task" className="text-lg font-semibold bg-gradient-to-r from-purple-300 to-indigo-400 text-transparent bg-clip-text hover:text-indigo-300 transition duration-200">
            All Task
          </Link>
